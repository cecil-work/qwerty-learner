...
export const dictionaries: Dictionary[] = [
  ...
  },
  {
    id: 'common_style_180',
    name: '常用句型180句',
    description: '常用句型180句',
    category: '句子背诵',
    url: './dicts/common_style_180.json',
    length: 180,
    chapterLength: 5,
    sentence: true,
  },
  ...
  },
  {
    id: '100_7000',
    name: '100句含7000雅思单词',
    description: '100句含7000雅思单词',
    category: '句子背诵',
    url: './dicts/100_7000.json',
    length: 100,
    chapterLength: 2,
    sentence: true,
  },
  { id: 'cet4', name: 'CET-4', description: '大学英语四级词库', category: '英语学习', url: './dicts/CET4_T.json', length: 2607 },
